...
def Camera_main( Camera_0):
    global  Camera_main_loop
    Camera_main_loop = Camera_0
...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='streams.txt',img_size=640, stride=32):
        ...
        self.img_size = img_size
        self.stride = stride
        #self.Camera_main_loop = Camera_main_loop_1
    ...
    def update(self, index, cap):
        ...
        n = 0
        while cap.isOpened():
            #print("Cmaemaa",Camera_main_loop)
            if Camera_main_loop is False:
                cap.release()
                print("Da Release")
                ...
                cap.grab()
                #print("self.Camera_main_loop",self.Camera_main_loop)
